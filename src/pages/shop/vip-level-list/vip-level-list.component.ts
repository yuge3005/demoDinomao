...
import { UIFromParent, StringTransform, StyleX } from 'resize-able-ui';
...
export class VipLevelListComponent extends UIFromParent {
  ...
  initUI(){
    ...
    this.sty.scrollBar = StyleX.combine( StyleX.setItemPosition(0,80), StyleX.setSize(730,0,true,false) );
  }
