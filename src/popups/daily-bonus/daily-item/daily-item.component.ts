import { UIFromParent, Point, SoundManager, StyleX } from '../../../basicUI/basic-ui.module';
...
export class DailyItemComponent extends UIFromParent {
  ...
  initUI() {
    ...
    this.sty.handImg = StyleX.setItemPosition( 60, 180 );
    this.sty.passedMask = StyleX.combine( StyleX.borderRadius(15), StyleX.setItemRect(0,0,197,248), StyleX.backgroundColor(0,0.5) );
  }
